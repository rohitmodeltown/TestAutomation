...
public class UserManagement {
	...
	public static void createUserLandingPage() throws Exception {
		Log.info("Landing on Create User form");

		TestConstant.userHeaderClick = TestConstant.driver.findElement(By
				.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userHeaderClickElementFiled)));
		...
		TestConstant.userSubMenuHeader = TestConstant.driver.findElement(By.xpath(
				configurationfilepath.ConfigurationFile.getProperty(TestConstant.userSubMenuHeaderClickElementFiled)));
		...
		Thread.sleep(1000);
		TestConstant.userCreateTab = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userCreateTabElementField)));
	...
	public static void createUserForm() throws Exception {
		...
		// Enter First Name
		TestConstant.userFirstName = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userFirstNameElementField)));
		TestConstant.userFirstName.sendKeys("Balaswamimurgan");
		Generic.takeScreenshot(TestConstant.driver, "UserFirstName");

		// Enter Last Name
		TestConstant.userLastName = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userLastNameElementField)));
		...
		TestConstant.userEmail = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userEmailElementField)));
		...
		TestConstant.description = TestConstant.driver.findElement(By
				.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.UserDescriptionElementField)));
		...
		// Mobile
		TestConstant.userMobile = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userMobileElementField)));
		...
		// Entity
		TestConstant.userEntityName = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userEntityNameElementField)));
	...
	///// Click to Arrow Button of Entity.
		TestConstant.driver
				.findElement(By.xpath("//img[@src='themes/SuiteP/images/id-ff-select.png?v=0O-9i6wcD4_tm-CNHS8OFA']")).click();
		...
		Thread.sleep(2000);
		TestConstant.entitySaveButton = TestConstant.driver.findElement(
				By.xpath(configurationfilepath.ConfigurationFile.getProperty(TestConstant.userSaveButtonElementField)));
